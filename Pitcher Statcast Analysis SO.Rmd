...
fit_10 <- kmeans(x = scale_pitchers_2016[4:140], # Set data as explantory variables 
...
set.seed(12345) # Set seed for reproducibility
fit_11 <- kmeans(x = scale_pitchers_2017[4:140], # Set data as explantory variables 
                centers = 4,  # Set number of clusters
                nstart = 25, # Set number of starts
                iter.max = 100 ) # Set maximum number of iterations to use
...
set.seed(12345) # Set seed for reproducibility
fit_12 <- kmeans(x = scale_pitchers_2018[4:140], # Set data as explantory variables 
                centers = 4,  # Set number of clusters
                nstart = 25, # Set number of starts
                iter.max = 100 ) # Set maximum number of iterations to use
...
set.seed(12345) # Set seed for reproducibility
fit_13 <- kmeans(x = scale_pitchers_2019[4:140], # Set data as explantory variables 
                centers = 4,  # Set number of clusters
                nstart = 25, # Set number of starts
                iter.max = 100 ) # Set maximum number of iterations to use
...
scale_pitchers_2019$last_name[clusters_1 == 3] 
...
set.seed(12345) # Set seed for reproducibility
fit_14 <- kmeans(x = scale_pitchers_2020[4:140], # Set data as explantory variables 
                centers = 4,  # Set number of clusters
                nstart = 25, # Set number of starts
                iter.max = 100 ) # Set maximum number of iterations to use
...
updated_pitchers_no_name <- updated_pitchers[, c(4:6, 8:140)]
...
bag_mod <- randomForest(p_win ~., # Set tree formula
                ...
                mtry = 135, # Set mtry to number of variables 
...
bag_mod_2 <- randomForest(p_win ~., # Set tree formula
                data = train_data, # Set dataset
                mtry = 135, # Set number of variables to try  
...
dtrain <- xgb.DMatrix(data = as.matrix(train_data[, c(1:2, 4:136)]), label = train_data$p_win)
# Create test matrix
dtest <- xgb.DMatrix(data = as.matrix(test_data[, c(1:2, 4:136)]), label = test_data$p_win)
```
...
shap_result <- shap.score.rank(xgb_model = bst_1, 
                X_train =as.matrix(train_data[, c(1:2, 4:136)]),
                shap_approx = F)
...
```{r}
summary(non_elite_pitchers_2016)
...
```{r}
print("2016 Groundballs")
mean(elite_pitchers_2016$groundballs)
mean(non_elite_pitchers_2016$groundballs)
